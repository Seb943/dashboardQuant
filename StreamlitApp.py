...
################### 0 - Initialization ###################
# 0 - Load files
# df = pd.read_csv(r"C:\Users\Utilisateur\Desktop\_Betting2024\Codes\tennis\Data\backtest_KNN50_250_fav0.55.csv", sep = ';')
df = pd.read_csv("./Data/backtest_KNN50_250_fav0.55.csv", sep = ';')
